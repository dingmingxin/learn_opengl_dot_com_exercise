...
main()
{
	...
	shader_create_with_file(&lightShader, "2.1.cube.fs", "2.1.cube.vs");
	shader_create_with_file(&lampShader, "2.1.lamp.fs", "2.1.lamp.vs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		shader_set_uniform(&lightShader, "lightPos", UNIFORM_FLOAT3, lightPos);
		...
		kmMat4Translation(&tmp, lightPos[0], lightPos[1], lightPos[2]);
